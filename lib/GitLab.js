...
class GitLab extends API {
    ...
    constructor(options) {
        ...
        if ({}.hasOwnProperty.call(options, "url")) {
            apiEndpoint = this.buildAPIEndpoint(options.url);
        }
    ...
    buildAPIEndpoint(baseURL) {
        ...
        baseURL = API.removeSlashes(baseURL);
    ...
    /**
     * Wrapper function around getUsersRepoCommitsCount to trigger the first repo commits GET call
     */
